...
class DataExcepion(TException):
    ...
    def __init__(self, message=None, callStack=None, date=None,):
        super(DataExcepion, self).__setattr__('message', message)
        super(DataExcepion, self).__setattr__('callStack', callStack)
        super(DataExcepion, self).__setattr__('date', date)
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('DataExcepion')
...
all_structs.append(DataExcepion)
DataExcepion.thrift_spec = (
    None,  # 0
