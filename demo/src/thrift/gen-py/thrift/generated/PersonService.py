...
class Iface(object):
    def getPersonByUsername(self, usrname):
        """
        Parameters:
         - usrname
...
class Processor(Iface, TProcessor):
    ...
    def process_getPersonByUsername(self, seqid, iprot, oprot):
        ...
        result = getPersonByUsername_result()
        try:
            result.success = self._handler.getPersonByUsername(args.usrname)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except DataExcepion as dataException:
            msg_type = TMessageType.REPLY
...
class getPersonByUsername_args(object):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRING:
                    self.usrname = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.usrname is not None:
            oprot.writeFieldBegin('usrname', TType.STRING, 1)
            oprot.writeString(self.usrname.encode('utf-8') if sys.version_info[0] == 2 else self.usrname)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()

    def validate(self):
        if self.usrname is None:
            raise TProtocolException(message='Required field usrname is unset!')
        return
...
getPersonByUsername_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'usrname', 'UTF8', None, ),  # 1
)
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                ...
                if ftype == TType.STRUCT:
                    self.dataException = DataExcepion.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
...
getPersonByUsername_result.thrift_spec = (
    ...
    (1, TType.STRUCT, 'dataException', [DataExcepion, None], None, ),  # 1
)
