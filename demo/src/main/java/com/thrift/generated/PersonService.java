...
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.14.1)", date = "2021-03-30")
public class PersonService {

  public interface Iface {

    public Person getPersonByUsername(java.lang.String usrname) throws DataExcepion, org.apache.thrift.TException;

    public void savePerson(Person person) throws DataExcepion, org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void getPersonByUsername(java.lang.String usrname, org.apache.thrift.async.AsyncMethodCallback<Person> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public Person getPersonByUsername(java.lang.String usrname) throws DataExcepion, org.apache.thrift.TException
    {
      send_getPersonByUsername(usrname);
      return recv_getPersonByUsername();
    }

    public void send_getPersonByUsername(java.lang.String usrname) throws org.apache.thrift.TException
    {
      getPersonByUsername_args args = new getPersonByUsername_args();
      args.setUsrname(usrname);
      sendBase("getPersonByUsername", args);
    }

    public Person recv_getPersonByUsername() throws DataExcepion, org.apache.thrift.TException
    {
    ...
    public void recv_savePerson() throws DataExcepion, org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void getPersonByUsername(java.lang.String usrname, org.apache.thrift.async.AsyncMethodCallback<Person> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      getPersonByUsername_call method_call = new getPersonByUsername_call(usrname, resultHandler, this, ___protocolFactory, ___transport);
    ...
    public static class getPersonByUsername_call extends org.apache.thrift.async.TAsyncMethodCall<Person> {
      ...
      public getPersonByUsername_call(java.lang.String usrname, org.apache.thrift.async.AsyncMethodCallback<Person> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
      ...
      public Person getResult() throws DataExcepion, org.apache.thrift.TException {
    ...
    public static class savePerson_call extends org.apache.thrift.async.TAsyncMethodCall<Void> {
      ...
      public Void getResult() throws DataExcepion, org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new java.lang.IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class getPersonByUsername<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getPersonByUsername_args> {
      ...
      public getPersonByUsername_result getResult(I iface, getPersonByUsername_args args) throws org.apache.thrift.TException {
        getPersonByUsername_result result = new getPersonByUsername_result();
        try {
          result.success = iface.getPersonByUsername(args.usrname);
        } catch (DataExcepion dataException) {
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class getPersonByUsername<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getPersonByUsername_args, Person> {
      ...
      public org.apache.thrift.async.AsyncMethodCallback<Person> getResultHandler(final org.apache.thrift.server.AbstractNonblockingServer.AsyncFrameBuffer fb, final int seqid) {
        ...
        return new org.apache.thrift.async.AsyncMethodCallback<Person>() { 
          ...
          public void onError(java.lang.Exception e) {
            ...
            getPersonByUsername_result result = new getPersonByUsername_result();
            if (e instanceof DataExcepion) {
              result.dataException = (DataExcepion) e;
      ...
      public void start(I iface, getPersonByUsername_args args, org.apache.thrift.async.AsyncMethodCallback<Person> resultHandler) throws org.apache.thrift.TException {
        iface.getPersonByUsername(args.usrname,resultHandler);
      }
    }
  ...
  public static class getPersonByUsername_args implements org.apache.thrift.TBase<getPersonByUsername_args, getPersonByUsername_args._Fields>, java.io.Serializable, Cloneable, Comparable<getPersonByUsername_args>   {
    ...
    private static final org.apache.thrift.protocol.TField USRNAME_FIELD_DESC = new org.apache.thrift.protocol.TField("usrname", org.apache.thrift.protocol.TType.STRING, (short)1);
    ...
    public @org.apache.thrift.annotation.Nullable java.lang.String usrname; // required

    /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
      USRNAME((short)1, "usrname");
    ...
    static {
      ...
      tmpMap.put(_Fields.USRNAME, new org.apache.thrift.meta_data.FieldMetaData("usrname", org.apache.thrift.TFieldRequirementType.REQUIRED, 
    ...
    public getPersonByUsername_args(getPersonByUsername_args other) {
      if (other.isSetUsrname()) {
        this.usrname = other.usrname;
      }
    }
    ...
    public getPersonByUsername_args setUsrname(@org.apache.thrift.annotation.Nullable java.lang.String usrname) {
      this.usrname = usrname;
      return this;
    }

    public void unsetUsrname() {
      this.usrname = null;
    }

    /** Returns true if field usrname is set (has been assigned a value) and false otherwise */
    public boolean isSetUsrname() {
      return this.usrname != null;
    }

    public void setUsrnameIsSet(boolean value) {
      if (!value) {
        this.usrname = null;
      }
    }
    ...
    public boolean equals(getPersonByUsername_args that) {
      ...
      boolean this_present_usrname = true && this.isSetUsrname();
      boolean that_present_usrname = true && that.isSetUsrname();
      if (this_present_usrname || that_present_usrname) {
        if (!(this_present_usrname && that_present_usrname))
          return false;
    ...
    public int hashCode() {
      ...
      hashCode = hashCode * 8191 + ((isSetUsrname()) ? 131071 : 524287);
      if (isSetUsrname())
        hashCode = hashCode * 8191 + usrname.hashCode();
    ...
    public int compareTo(getPersonByUsername_args other) {
      ...
      lastComparison = java.lang.Boolean.compare(isSetUsrname(), other.isSetUsrname());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetUsrname()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.usrname, other.usrname);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
    ...
    public void validate() throws org.apache.thrift.TException {
      ...
      if (usrname == null) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'usrname' was not present! Struct: " + toString());
      }
    ...
    private static class getPersonByUsername_argsStandardScheme extends org.apache.thrift.scheme.StandardScheme<getPersonByUsername_args> {
          ...
          switch (schemeField.id) {
            case 1: // USRNAME
              if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
                struct.usrname = iprot.readString();
                struct.setUsrnameIsSet(true);
              } else { 
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getPersonByUsername_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.usrname != null) {
          oprot.writeFieldBegin(USRNAME_FIELD_DESC);
          oprot.writeString(struct.usrname);
          oprot.writeFieldEnd();
        }
  ...
  public static class getPersonByUsername_result implements org.apache.thrift.TBase<getPersonByUsername_result, getPersonByUsername_result._Fields>, java.io.Serializable, Cloneable, Comparable<getPersonByUsername_result>   {
    ...
    public @org.apache.thrift.annotation.Nullable DataExcepion dataException; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.DATA_EXCEPTION, new org.apache.thrift.meta_data.FieldMetaData("dataException", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, DataExcepion.class)));
      metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
    ...
    public getPersonByUsername_result(getPersonByUsername_result other) {
      ...
      if (other.isSetDataException()) {
        this.dataException = new DataExcepion(other.dataException);
      }
    }
    ...
    @org.apache.thrift.annotation.Nullable
    public DataExcepion getDataException() {
      return this.dataException;
    }

    public getPersonByUsername_result setDataException(@org.apache.thrift.annotation.Nullable DataExcepion dataException) {
      this.dataException = dataException;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
      ...
      case DATA_EXCEPTION:
        if (value == null) {
          ...
          setDataException((DataExcepion)value);
        }
        break;
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, getPersonByUsername_result struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            ...
            case 1: // DATA_EXCEPTION
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.dataException = new DataExcepion();
  ...
  public static class savePerson_result implements org.apache.thrift.TBase<savePerson_result, savePerson_result._Fields>, java.io.Serializable, Cloneable, Comparable<savePerson_result>   {
    ...
    public savePerson_result setDataException(@org.apache.thrift.annotation.Nullable DataExcepion dataException) {
      this.dataException = dataException;
      return this;
    }
