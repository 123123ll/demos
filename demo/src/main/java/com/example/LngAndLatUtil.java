...
public class LngAndLatUtil {
	public static void main(String[] args) throws UnsupportedEncodingException, NoSuchAlgorithmException {
		String address = LngAndLatUtil.getLngAndLat("120.004856","30.285459"); //121.64054,31.194304
...
//            JSONObject result = JSONObject.parseObject(JSONObject.parseObject(obj.get("result").toString()).get("formatted_address").toString());
           // address = obj.getJSONObject("result").getString("formatted_address");
            address = (String) JSONObject.parseObject(obj.get("result").toString()).get("formatted_address");
        } catch (Exception e) {
