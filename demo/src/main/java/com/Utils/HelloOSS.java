...
public class HelloOSS {
    ...
    private static String accessKeyId = "LTAI4G627rx4mLhChz63EETf";
    private static String accessKeySecret = "cRajJUXspCzyPpMltLTydDOBBdbHxB";

    // Bucket用来管理所存储Object的存储空间，详细描述请参看“开发人员指南 > 基本概念 > OSS基本概念介绍”。
    // Bucket命名规范如下：只能包括小写字母，数字和短横线（-），必须以小写字母或者数字开头，长度必须在3-63字节之间。
    private static String bucketName = "tmzhyj";
...
//        PropertyConfigurator.configure("conf/log4j.properties");
        ...
        try {
            ...
            String picUrl = "https://fastgw-ali.ys7.com/1/capture/2021/4/8/gjx5ycuajxd1c0eesm7p67eo.jpg?Expires=1617970089&OSSAccessKeyId=LTAIzI38nEHqg64n&Signature=v1hujgvido01Ws6WqJRDU52LQSs%3D&bucket=ezviz-fastdfs-gateway";
            MultipartFile fileItem = Base64Utils.createFileItem(picUrl, 1111 + ".jpg");
            ossClient.putObject(bucketName, firstKey, fileItem.getInputStream());
